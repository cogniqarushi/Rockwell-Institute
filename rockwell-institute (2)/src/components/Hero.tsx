...
export default function Hero({ onBrowseCourses, onOpenCalculator }: HeroProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-transparent py-12 lg:py-12 xl:py-16 lg:min-h-[calc(100vh-80px)] flex items-center border-b border-stone-200/40">
